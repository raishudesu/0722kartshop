  ...
  return (
    <div className="w-full max-h-fit md:h-screen md:p-6">
      <div className="w-full flex flex-col md:flex-row justify-center md:gap-10">
        ...
        <div className="p-2 flex flex-col justify-center items-center w-full md:w-[30%] md:p-0 max-h-fit">
          <div className="flex flex-col gap-3 w-full">
            <h1 className="text-md md:text-4xl font-black uppercase">{status}</h1>
